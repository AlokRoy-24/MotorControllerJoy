...
echo_and_run cd "/home/alok/catkin_ws/src/rosserial/rosserial_vex_v5"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/alok/catkin_ws/src/rosserial/rosserial_vex_v5/setup.py" \
     \
    build --build-base "/home/alok/catkin_ws/build/rosserial/rosserial_vex_v5" \
    install \
    --root="${DESTDIR-/}" \
